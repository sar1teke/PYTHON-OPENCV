...
class EuclideanDistTracker:
    def __init__(self):
        # Nesnelerin merkez konumlarını Saklama
        self.center_points = {}
    ...
    def update(self, objects_rect):
        ...
        # Yeni nesnenin merkez noktasının alınması
        for rect in objects_rect:
            x, y, w, h = rect
            cx = (x + x + w) // 2
            cy = (y + y + h) // 2

            # NESNE ZATEN ALGILANMIŞ OLUP OLMADIĞINI KONTROL ETME
            ...
            for id, pt in self.center_points.items():
                ...
                if dist < 70:
                    ...
                    # ZAMANLAYICIYI DURDURUN VE FARKI BULUN
                    if (y >= 235 and y <= 255):
